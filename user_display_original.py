"""Original unoptimized user display implementation (reference).

This file is an unchanged copy of the previously provided `user_display_current.py`.
It is kept for test comparisons and for documenting the before/after behaviour.
"""
...
if __name__ == "__main__":
    print("Original Implementation Output (sample):")
    print("=" * 100)
