"""Original user display implementation (unchanged from current).

This file is a preserved copy of the initial `user_display_current.py` so
that we can keep a reference implementation for testing and comparison.
"""
...
# Sample data preserved for tests / manual runs
sample_users = [
    {
        'id': 1,
        'name': 'John Doe',
